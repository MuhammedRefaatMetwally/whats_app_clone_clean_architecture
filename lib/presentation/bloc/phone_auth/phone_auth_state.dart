...
class CountryDialogPickedCountry extends PhoneAuthState {
  Country selectedFilteredDialogCountry;
  String countryCode;

  CountryDialogPickedCountry(
      {required this.selectedFilteredDialogCountry, required this.countryCode});

  @override

  List<Object?> get props => [countryCode,selectedFilteredDialogCountry];
}

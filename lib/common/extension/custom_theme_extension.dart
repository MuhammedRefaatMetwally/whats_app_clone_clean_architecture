...
class CustomThemeExtension extends ThemeExtension<CustomThemeExtension> {
  ...
  static const lightMode = CustomThemeExtension(
    ...
    greyColor: Palette.greyLight,
    blueColor: Palette.blueLight,
    langBgColor: Color(0xFFF7F8FA),
    langHightlightColor: Color(0xFFE8E8ED),
    authAppbarTextColor: Palette.greenLight,
  ...
  static const darkMode = CustomThemeExtension(
    circleImageColor: Palette.greenDark,
    greyColor: Palette.greyDark,
    blueColor: Palette.blueDark,
